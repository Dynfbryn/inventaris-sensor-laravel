<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Inventaris') }}</h2>
    </x-slot>

    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Form Edit Inventaris</h1>

                <form action="{{ route('admin.inventaris.update', $item->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-4">
                        ...
                        <button type="submit" class="px-6 py-3 bg-gradient-to-r from-purple-500 to-fuchsia-600 text-white rounded-xl hover:from-purple-600 hover:to-fuchsia-700 shadow-lg">Update Barang</button>
                    </div>
                </form>
            </div>
        </div>
