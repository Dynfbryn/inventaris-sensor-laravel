        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <!-- Kategori Sensor -->
                    <a href="{{ route('admin.kategori-sensor.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-teal-50 to-teal-100 hover:from-teal-500 hover:to-teal-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                    ...
                    <!-- Lokasi -->
                    <a href="{{ route('admin.lokasi.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-indigo-50 to-indigo-100 hover:from-indigo-500 hover:to-indigo-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                        <div class="relative">
                            <div class="flex flex-col items-center text-center">
                                <div class="text-5xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Manage Users -->
                    <a href="{{ route('admin.users.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-500 hover:to-blue-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                        <div class="relative">
                            <div class="flex flex-col items-center text-center">
                                <div class="text-5xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <a href="{{ route('admin.sensors.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-green-50 to-green-100 hover:from-green-500 hover:to-green-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                        <div class="relative">
                            <div class="flex flex-col items-center text-center">
                                <div class="text-5xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Manage Inventaris -->
                    <a href="{{ route('admin.inventaris.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-500 hover:to-purple-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                        <div class="relative">
                            <div class="flex flex-col items-center text-center">
                                <div class="text-5xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <!-- Reports -->
                    <a href="{{ route('admin.reports.index') }}" class="group relative overflow-hidden bg-gradient-to-br from-red-50 to-red-100 hover:from-red-500 hover:to-red-600 rounded-xl p-6 transition-all duration-300 shadow-md hover:shadow-2xl transform hover:-translate-y-1">
                        <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full group-hover:scale-150 transition-transform duration-300"></div>
                        <div class="relative">
                            <div class="flex flex-col items-center text-center">
                                <div class="text-5xl mb-3 transform group-hover:scale-110 transition-transform duration-300">
